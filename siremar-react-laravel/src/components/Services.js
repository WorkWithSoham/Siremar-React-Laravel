  ...
  return (
    <div class="services">
      ...
      <p class="serviceParagraph">
        <span>
          Margarita Island stands out for having all the necessary services for
          your care, comfort and protection. <br /> You will find the satisfaction of
          your basic needs, as well as the most sophisticated ones
        </span>
        <ul style={{ 'listStyle': 'none', lineHeight: '2' }}>
          <li>Basic services - commodities: electricity, water, sanitation.</li>
          <li>
